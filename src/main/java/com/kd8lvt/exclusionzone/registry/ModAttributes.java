...
public class ModAttributes {
    ...
    public static RegistryEntry<EntityAttribute> TOXIN_RESISTANCE = register(TOXIN_RESISTANCE_ID,new DynamicEntityAttribute(TOXIN_RESISTANCE_ID.toTranslationKey("attribute")).setTracked(true));;
