...
public class ModBlocks {
    ...
    public static BlockEntityType<FluidPipeBE> FLUID_PIPE_BE;
    ...
    public static void ready() {
        ...
        FLUID_PIPE = ModBlockRegistry.FLUID_PIPE.value();
        ...
        FLUID_PIPE_BE = (BlockEntityType<FluidPipeBE>)ModBlockRegistry.FLUID_PIPE_BE.value();
    }
}
