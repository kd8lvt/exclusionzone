...
import com.kd8lvt.exclusionzone.init.Blocks.util.transaction.TransactionTypes;
...
public class FluidPipeBE extends BlockEntity {
    public SingleVariantStorage<FluidVariant> fluid = new SingleVariantStorage<>() {
        @Override
    ...
    public FluidPipeBE(BlockPos pos, BlockState state) {
        this(ModBlocks.FLUID_PIPE_BE,pos,state);
    }
}
